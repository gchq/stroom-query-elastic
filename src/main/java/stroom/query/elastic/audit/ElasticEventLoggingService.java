package stroom.query.elastic.audit;
...
public class ElasticEventLoggingService extends DefaultEventLoggingService implements EventLoggingService {

    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticEventLoggingService.class);
    ...
    @Inject
    public ElasticEventLoggingService() {
