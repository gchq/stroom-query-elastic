...
import stroom.query.elastic.audit.KafkaLogbackAppender;
import stroom.query.elastic.audit.KafkaLogbackAppenderFactory;
...
public class KafkaAuditTestConsumer {
    ...
    public KafkaAuditTestConsumer() {
        ...
        final Logger auditLogger = LoggerFactory.getLogger(ElasticEventLoggingService.AUDIT_LOGGER_NAME);
