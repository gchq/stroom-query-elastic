...
import stroom.query.jooq.*;

/**
 * This is a lot like the AuditedJooqQueryBundle, but it allows the specification of any Query Service Impl
 * @param <CONFIG> The configuration class
 * @param <QUERY_SERVICE> The query service implementation, could be any class that extends QueryService.
