 ...
 */
public class QueryResourceClientSpy<WRAPPED extends QueryResource & Closeable>
        implements QueryResource, Closeable {

    private final WRAPPED wrapped;

    public static <W extends QueryResource & Closeable>
    QueryResourceClientSpy wrapping(final W wrapped) {
        return new QueryResourceClientSpy<>(wrapped);
    }

    private QueryResourceClientSpy(final WRAPPED wrapped) {
